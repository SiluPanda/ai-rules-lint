 ...
 */
const VAGUE_PATTERNS: Array<{ pattern: RegExp; example: string }> = [
 ...
 */
export const vagueInstruction: LintRule = {
 ...
 */
function subjectsContradict(a: string, b: string): boolean {
  ...
  if (contentWordsA.length === 0 || contentWordsB.length === 0) return false;
 ...
 */
export const redundantInstruction: LintRule = {
  ...
  check(document, context, options) {
    const threshold = (options?.threshold as number) ?? 0.6;
 ...
 */
export const contradictoryRules: LintRule = {
 ...
 */
export const unsafeInstruction: LintRule = {
 ...
 */
export const missingSpecificity: LintRule = {
