 ...
 */
export const redundantWhitespace: LintRule = {
 ...
 */
export const commentedOutContent: LintRule = {
  ...
  check(document, context) {
    ...
    while ((match = commentRegex.exec(document.source)) !== null) {
      ...
      if (commentContent.startsWith('ai-rules-lint')) continue;
 ...
 */
export const excessiveFormatting: LintRule = {
...
export const efficiencyRules: LintRule[] = [redundantWhitespace, commentedOutContent, excessiveFormatting];
