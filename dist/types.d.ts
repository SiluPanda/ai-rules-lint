 ...
 */
export type FileFormat = 'claude-md' | 'cursorrules' | 'agents-md' | 'gemini-md' | 'copilot-instructions' | 'windsurfrules' | 'clinerules' | 'custom';
/**
 ...
 * Rule category.
 */
export type RuleCategory = 'length' | 'structure' | 'content' | 'reference' | 'anti-pattern' | 'format-specific' | 'efficiency';
/**
