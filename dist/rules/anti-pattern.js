...
exports.antiPatternRules = exports.datedContent = exports.todoPlaceholder = exports.noExamples = exports.tooManyRules = exports.negativeOnly = exports.personalityInstruction = void 0;
/**
 * personality-instruction: detects personality/emotional directives.
 */
exports.personalityInstruction = {
...
exports.negativeOnly = {
    ...
    check(document, context, options) {
        ...
        for (const section of document.sections) {
            ...
            const sectionInstructions = document.instructions.filter(inst => inst.location.startLine >= section.location.startLine &&
                inst.location.startLine <= section.location.endLine);
            if (sectionInstructions.length < 3)
                continue; // Need enough instructions to judge
...
exports.noExamples = {
    ...
    check(document, context) {
        ...
        const hasCodingInstructions = document.instructions.some(inst => /\b(?:code|function|variable|class|import|export|format|indent|naming|style|type|interface)\b/i.test(inst.text));
        if (!hasCodingInstructions)
            return;
